...
INSERT INTO matches (
	...
	(1, 5, 1, 6, 3.03, 4.97, NULL, NULL, 'created', now() + interval '2 days 0 hours'),
	(1, 5, 7, 5, 1.61, 2.21, NULL, NULL, 'created', now() + interval '2 days 2 hours'),
	(1, 5, 8, 4, 2.85, 4.28, NULL, NULL, 'created', now() + interval '2 days 4 hours'),
	(1, 5, 9, 3, 2.15, 3.58, NULL, NULL, 'created', now() + interval '2 days 6 hours'),
	(1, 5, 10, 2, 2.35, 3.13, NULL, NULL, 'created', now() + interval '2 days 8 hours'),
